...
abstract class AbstractTaskIdTest<Id : TaskId> {
    ...
    abstract fun createTaskId(scope: Scope, value: String): EitherNel<TaskIdError, Id>

    private fun createTaskId(value: String) =
        createTaskId(createScopeOrThow("randomScope"), value)

    private fun createTaskIdOrThrow(value: String) =
        createTaskId(createScopeOrThow("randomScope"), value).getOrElse { throw IllegalStateException() }
