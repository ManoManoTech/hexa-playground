...
class DeletedTaskId private constructor(value: String) : TaskId, AbstractStringValue(value) {

    companion object {
        operator fun invoke(stringBetween1And36Chars: String): Either<NonEmptyList<TaskIdError>, DeletedTaskId> =
            either {
                zipOrAccumulate(
                    ...
                    DeletedTaskId(stringBetween1And36Chars)
                }
            }
    }
}