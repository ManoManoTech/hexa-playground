...
class InProgressMissionId private constructor(override val squadKey: SquadKey, override val value: String) :
    AbstractMissionId() {
    ...
    companion object {
        ...
        ): Either<NonEmptyList<MissionIdError>, InProgressMissionId> =
            either {
                zipOrAccumulate(
                    {
