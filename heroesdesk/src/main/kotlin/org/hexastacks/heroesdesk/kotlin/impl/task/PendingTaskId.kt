...
class PendingTaskId private constructor(value: String) : TaskId, AbstractStringValue(value) {

    companion object {

        operator fun invoke(stringBetween1And36Chars: String): Either<NonEmptyList<TaskIdError>, PendingTaskId> =
            either {
                zipOrAccumulate(
                    ...
                    PendingTaskId(stringBetween1And36Chars)
                }
            }
    }
}